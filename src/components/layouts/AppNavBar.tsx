...
import { Typography, Navbar, Button, IconButton, MobileNav } from '@/components/ui/shared';
  ...
  const navList = (
    ...
    >
      <Typography
        ...
        variant="small"
        color="blue-gray"
        className={classNames('flex', 'items-center', 'gap-x-2', 'p-1', 'font-medium')}
      >
        <svg
          width="16"
          height="15"
        ...
        <a href="#" className={classNames('flex', 'items-center')}>
          Pages
        </a>
      </Typography>
      <Typography
    ...
    >
      ...
      >
        <Typography
          as="a"
          href="#"
          className={classNames('mr-4', 'cursor-pointer', 'py-1.5', 'font-medium')}
        >
          Material Tailwind
        </Typography>
        <div className={classNames('hidden', 'lg:block')}>{navList}</div>
        <div className={classNames('flex', 'items-center', 'gap-x-1')}>
          <Button variant="text" size="sm" className={classNames('hidden', 'lg:inline-block')}>
            <span>Log In</span>
          </Button>
          <Button variant="gradient" size="sm" className={classNames('hidden', 'lg:inline-block')}>
            <span>Sign in</span>
          </Button>
        </div>
        <IconButton
      ...
      <MobileNav open={openNav}>
        <div className={classNames('container', 'mx-auto')}>
          {navList}
          <div className={classNames('flex', 'items-center', 'gap-x-1')}>
            <Button fullWidth variant="text" size="sm" className={classNames('')}>
              <span>Log In</span>
            </Button>
            <Button fullWidth variant="gradient" size="sm" className={classNames('')}>
              <span>Sign in</span>
            </Button>
          </div>
        </div>
